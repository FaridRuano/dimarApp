							...
							<CardBody className="bg-warning">
								<Media className="static-top-widget row">
									...
									<Media body className="col-8">
										<span className="m-0">Ganancias</span>
										<h3 className="mb-0">
											$ <CountUp className="counter" end={6659} />
											<small> Presente mes</small>
										</h3>
									</Media>
								</Media>
							</CardBody>
						...
						<Card className=" o-hidden  widget-cards">
							<CardBody className="bg-secondary ">
								<Media className="static-top-widget row">
									...
									<Media body className="col-8">
										<span className="m-0">Ventas</span>
										<h3 className="mb-0">
						...
						<Card className="o-hidden widget-cards">
							<CardBody className="bg-primary">
								<Media className="static-top-widget row">
									...
									<Media body className="col-8">
										<span className="m-0">Clientes</span>
										<h3 className="mb-0">
						...
						<Card className=" o-hidden widget-cards">
							<CardBody className="bg-danger ">
								<Media className="static-top-widget row">
									...
									<Media body className="col-8">
										<span className="m-0">Impuestos</span>
										<h3 className="mb-0">
									...
									<Table borderless>
										...
										<tbody>
											<tr>
												...
												<td className="digits">Enviado</td>
											</tr>
											<tr>
												<td>2</td>
											...
											<tr>
												...
												<td className="digits">Iniciado</td>
											</tr>
											<tr>
												<td>4</td>
												<td className="digits">$120.00</td>
												<td className="font-primary">Direct Deposit</td>
												<td className="digits">Procesando</td>
											</tr>
											<tr>
												<td>5</td>
												<td className="digits">$50.00</td>
												<td className="font-primary">Bank Transfers</td>
												<td className="digits">Fabricando</td>
											</tr>
										</tbody>
									</Table>
									<Button>
										<Link to="/dashboard" style={{textDecoration: 'none'}}>
											<p style={{color: 'white'}}> Ver todas las ordenes </p>											
										</Link>
									</Button>									
								</div>
							</CardBody>
